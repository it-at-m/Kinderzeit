                ...
                <div className="w-full h-[15rem] md:h-[20rem] relative flex flex-row items-center">
                    ...
                    <div className="font-[500] text-[1.3rem] lg:block hidden">
                        <div className="">
                            ...
                            <button className="text-white font-semibold rounded-md px-4 bg-gradient-to-r pb-1 from-yellow-500 via-violet-300 via-indigo-300 via-blue-400 via-green-300 via-teal-400 via-indigo-300 via-pink-300 to-red-500">
                                eine große Auswahl →{' '}
                            </button>{' '}
