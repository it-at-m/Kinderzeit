        ...
        <>
                                    ...
                                    <div
                                        ...
                                        onClick={() => {
                                            if (holiday === selectedHoliday)
                                                setSelectedHoliday(null)
                                            else setSelectedHoliday(holiday)
                                        }}
                                        className={
            ...
            <div className="w-full max-w-5xl m-auto">
                {filteredEvents.map((ev) => (
                    ...
                    >
                        <div className="font-bold flex flex-wrap w-32 text-clip">
                            {ev.name}
                        </div>
                        ...
                        <div className="h-full w-1/3 flex flex-wrap">
                            {ev.generalTags.map((tagText) => (
                                <div
                                    key={tagText}
                                    className="bg-slate-200 text-xs px-1 rounded m-auto border-purple-300"
                                >
                                    {tagText}
                                </div>
                            ))}
                        ...
                        <div className="h-full w-1/3 flex flex-wrap justify-center">
                            {ev.interests.slice(0, 8).map((interestText) => {
                                return (
                                    <div
                                        key={interestText}
                                        className="bg-green-300 border-green-200 mx-1 text-xs px-1 rounded m-auto"
                                    >
                                        {interestText}
                                    </div>
                                )
