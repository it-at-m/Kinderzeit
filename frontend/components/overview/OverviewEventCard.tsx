...
export default function OverviewEventCard({
    ...
    return (
        <div className="w-full h-full py-5 flex justify-center items-center">
            <div className="pl-1 flex justify-center rounded-xl">
                <div className="w-50 pb-2 bg-white rounded-xl shadow-xl">
                    <div className="pt-4">
                    ...
                    <div className="px-2 py-1 ">
                        {/* <!-- Product Title --> */}
                        <div className="text-xl px-2">{event.event_name}</div>
                        ...
                        <div className="p-3">
                            ...
                            <a className="flex justify-center items-center bottom-10 right-0 py-6 mr-24 font-semibold text-green-800">
                            ...
                            <div className="flex space-x-4">
                                <Link href={`/details/${event.id}`}>
                                    <div className="py-1 px-5 text-gray-500 underline decoration-1 cursor-pointer">
                                        mehr info
                                    </div>
                                </Link>
                                <Link href="#">
                                    <div className="px-4 py-1 bg-green-700 text-gray-100 rounded-full hover:bg-green-900">
                                        Jetzt buchen
                                    </div>
                                </Link>
                            </div>
